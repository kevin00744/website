...
declare class TraitManager extends Module<TraitManagerConfigModule> {
	...
	removeType(name: string): (new (o: any) => TraitView) | undefined;
	/**
	 * Get trait type
	 * @param {string} name Type name
	 * @returns {Object}
...
export type CommandPublicHandler = (...args: any[]) => any;
export type CommandPublicFnFromHandler<T> = T extends (editor: any, sender: any, ...args: infer P) => infer R ? (...args: P) => R : never;
export type CommandPublicOptions<T extends CommandPublicHandler> = Parameters<T> extends [
] ? undefined : Parameters<T>[0];
export interface ICommand<TRunOptions = any, TStopOptions = TRunOptions, TRunResult = any, TStopResult = any> {
...
export type CommandFunction<TRunOptions = any, TRunResult = any> = CommandAbstract<TRunOptions, any, TRunResult, any>["run"];
export interface CommandConstructor<TRunOptions = any, TStopOptions = TRunOptions, TRunResult = any, TStopResult = any> {
...
export type CommandObject<TRunOptions = any, T extends ObjectAny = {}, TStopOptions = TRunOptions, TRunResult = any, TStopResult = any> = ICommand<TRunOptions, TStopOptions, TRunResult, TStopResult> & T & ThisType<T & CommandAbstract<TRunOptions, TStopOptions, TRunResult, TStopResult>>;
declare class CommandAbstract<TRunOptions = any, TStopOptions = TRunOptions, TRunResult = any, TStopResult = any> extends Model {
	config: any;
	em: EditorModel;
	pfx: string;
	ppfx: string;
	 ...
	 * @private
	 * */
	callRun(editor: Editor, opts?: TRunOptions): TRunResult | undefined;
	/**
	 * Method that run command
	 * @param  {Object}  editor Editor instance
	 * @param  {Object}  [options={}] Options
	 * @private
	 * */
	callStop(editor: Editor, opts?: TStopOptions): TStopResult;
	/**
...
declare class CommandResize extends CommandAbstract<ComponentResizeOptions, ComponentResizeOptions, Resizer, void> {
...
export declare class Component extends StyleableModel<ComponentProperties> {
	 ...
	 */
	findType(query: ComponentMatcher, opts?: ComponentFindOptions): Component[];
	/**
	 ...
	 */
	closestType(query: ComponentMatcher): Component | undefined;
	/**
...
declare class CommandFullscreen extends CommandAbstract<CommandFullscreenOptions, CommandFullscreenOptions, void, void> {
	sender: any;
	 ...
	 * @return {string}
	 */
	enable(el?: HTMLElement | null): string;
	/**
	 * Disable fullscreen mode
	 */
	disable(): void;
	onFullscreenChange(): void;
	run(editor: any, sender: any, opts?: CommandFullscreenOptions): void;
	stop(_editor: any, sender: any, _opts?: CommandFullscreenOptions): void;
}
...
declare class CommandPreview extends CommandAbstract {
	...
	getPanels(editor: Editor): Panels;
	preventDrag(opts: any): void;
	tglEffects(on?: boolean): void;
...
declare class CommandComponentEnter extends CommandAbstract {
	run(ed: Editor): void;
}
...
declare class CommandComponentExit extends CommandAbstract {
	run(ed: Editor, _: any, opts?: any): void;
}
...
declare class CommandComponentDelete extends CommandAbstract<ComponentDeleteRunOptions> {
	run(ed: Editor, s: any, opts?: ComponentDeleteRunOptions): Component[];
}
...
declare class CommandComponentStyleClear extends CommandAbstract<ComponentStyleClearRunOptions> {
	run(ed: Editor, s: any, opts: ComponentStyleClearRunOptions): CssRule[];
}
export interface ComponentDragCommandRegistryRun {
	"core:component-drag": CommandPublicFnFromHandler<CommandComponentDrag["run"]>;
}
declare class CommandComponentDrag extends CommandAbstract<ComponentDragOpts> {
	editor: Editor;
	em: EditorModel;
	...
	dragger?: Dragger;
	run(editor: Editor, _sender: any, opts?: ComponentDragOpts): Dragger;
	...
	setPosition({ x, y, end, position, width, height }: any): void;
	_getDragData(): {
		target: Component;
	...
	onEnd(ev: Event, _dragger: any, opt: any): void;
	hideGuidesInfo(): void;
...
export interface ComponentOrigRect {
	top: number;
	left: number;
	width: number;
	height: number;
...
declare class CommandCopyComponent extends CommandAbstract {
	run(ed: Editor): void;
}
...
declare class CommandPasteComponent extends CommandAbstract<PasteComponentOptions> {
	run(ed: Editor, _sender: any, opts?: PasteComponentOptions): void;
}
...
declare class CommandCanvasMove extends CommandAbstract {
	editor: Editor;
	canvasModel: any;
	dragger?: Dragger;
	run(ed: Editor): void;
	...
	enableDragger(ev: Event): void;
	disableDragger(ev?: Event): void;
	toggleDragger(enable: boolean, ev: Event): void;
	toggleMove(enable?: boolean): void;
}
export interface CanvasClearCommandRegistryRun {
	"core:canvas-clear": CommandPublicFnFromHandler<CommandCanvasClear["run"]>;
}
declare class CommandCanvasClear extends CommandAbstract {
	run(ed: any): void;
}
...
declare class CommandExportTemplate extends CommandAbstract<ExportTemplateRunOptions, ExportTemplateRunOptions, void, void> {
	cm: Editor["CodeManager"] | null;
	editors?: HTMLElement;
	htmlEditor?: {
	...
	run(editor: Editor, sender: any, opts?: ExportTemplateRunOptions): void;
	stop(editor: Editor): void;
...
declare class CommandOpenAssets extends CommandAbstract {
	title: string;
	editor?: Editor;
	am?: any;
	rendered?: HTMLElement;
	open(content: string | HTMLElement): any;
	close(): any;
	run(editor: Editor, sender: any, opts?: any): this;
	stop(editor: Editor): void;
}
...
declare class CommandOpenLayers extends CommandAbstract {
...
declare class CommandOpenBlocks extends CommandAbstract {
	container?: HTMLElement;
	editor?: Editor;
	bm?: any;
	firstRender?: boolean;
...
declare class CommandMoveComponent extends CommandAbstract {
	[key: string]: any;
	init(o: any): void;
	run(...args: any[]): any;
	 ...
	 * @private
	 * */
	initSorter(e: any): void;
	/**
	 * Init sorter from model
	 * @param  {Object} model
	 * @private
	 */
	initSorterFromModel(model: Component): void;
	/**
	 * Init sorter from models
	 * @param  {Object} model
	 * @private
	 */
	initSorterFromModels(models: Component[]): void;
	onEndMoveFromModel(): void;
	/**
	 ...
	 * @private
	 * */
	rollback(e: any, force?: boolean): void;
	/**
	 * Returns badge element
	 * @return {HTMLElement}
	 * @private
...
declare class CommandSelectComponent extends CommandAbstract {
	[key: string]: any;
	 ...
	 * @private
	 * */
	startSelectComponent(): void;
	/**
	 * Stop select component event
	 * @private
	 * */
	stopSelectComponent(): void;
	/**
	 * Toggle select component event
	 * @private
	 * */
	toggleSelectComponent(enable?: boolean): void;
	/**
	 * Hover command
	 * @param {Object}  e
	 * @private
	...
	onFrameUpdated(): void;
	onHovered(em?: any, component?: Component): void;
	/**
	...
	updateLocalPos(data?: any): void;
	getElHovered(): any;
	getElSelected(): any;
	onOut(): void;
	toggleToolsEl(on?: boolean, view?: any, opts?: any): any;
	showElementOffset(el: HTMLElement, pos: any, opts?: any): void;
	hideElementOffset(view: any): void;
	showFixedElementOffset(el: HTMLElement, pos: any): void;
	hideFixedElementOffset(): void;
	hideHighlighter(view: any): void;
	onClick(ev: Event): void;
	select(model: Component, event: MouseEvent): void;
	updateBadge(el: HTMLElement, pos: any, opts?: any): void;
	showHighlighter(view: any): void;
	initResize(elem: any): void;
	updateToolbar(mod: any): void;
	updateToolbarPos(pos: any): void;
	getCanvasPosition(): ElementRect;
	getBadge(opts?: any): any;
	onCanvasScroll(e: any): void;
	onFrameScroll(_e?: any): void;
	onFrameResize(): void;
	updateTools(): void;
	isCompSelected(comp: Component): boolean;
	updateToolsLocal(data?: any): void;
	_upToolbar(): void;
	_trgToolUp(type: string, opts?: {}): void;
	updateToolsGlobal(opts?: any): void;
	updateAttached(): void;
	...
	hideBadge(): void;
	cleanPrevious(model: Component): void;
	getContentWindow(): Window;
	run(editor: any): void;
	stop(ed?: any, sender?: any, opts?: any): void;
}
...
declare class CommandShowOffset extends CommandAbstract {
	[key: string]: any;
	getOffsetMethod(state: string): string;
	run(editor: Editor, sender: any, opts: any): void;
	stop(editor: Editor, sender: any, opts?: any): void;
}
...
declare class CommandSwitchVisibility extends CommandAbstract {
	init(): void;
	run(ed: Editor): void;
	stop(ed: Editor): void;
	toggleVis(ed: Editor, active?: boolean): void;
	handleFrames(frames: Frame[], active?: boolean): void;
	_onFramesChange(_: any, frames: Frame[]): void;
	_upFrame(frame: Frame, active?: boolean): void;
}
...
declare class CommandOpenStyleManager extends CommandAbstract {
	sender?: any;
	sm?: any;
	$cnt?: any;
	$cntInner?: any;
...
declare class CommandOpenTraitManager extends CommandAbstract {
	sender?: any;
	target?: any;
	$cn?: any;
	$cn2?: any;
...
export type CommandRegistryHandler = (...args: any[]) => any;
export type CommandRegistryEntry<TRegistry, TId extends string> = TId extends keyof TRegistry ? TRegistry[TId] extends CommandRegistryHandler ? TRegistry[TId] : CommandRegistryHandler : CommandRegistryHandler;
export interface CommandRegistryRun extends FullscreenCommandRegistryRun, PreviewCommandRegistryRun, ResizeCommandRegistryRun, ComponentNextCommandRegistryRun, ComponentPrevCommandRegistryRun, ComponentEnterCommandRegistryRun, ComponentExitCommandRegistryRun, ComponentDeleteCommandRegistryRun, ComponentStyleClearCommandRegistryRun, ComponentDragCommandRegistryRun, CopyComponentCommandRegistryRun, PasteComponentCommandRegistryRun, CanvasMoveCommandRegistryRun, CanvasClearCommandRegistryRun, ExportTemplateCommandRegistryRun, MoveComponentCommandRegistryRun, OpenAssetsCommandRegistryRun, OpenBlocksCommandRegistryRun, OpenLayersCommandRegistryRun, OpenStyleManagerCommandRegistryRun, OpenTraitManagerCommandRegistryRun, SelectComponentCommandRegistryRun, ShowOffsetCommandRegistryRun, SwitchVisibilityCommandRegistryRun {
}
export interface CommandRegistryStop extends FullscreenCommandRegistryStop, PreviewCommandRegistryStop, ResizeCommandRegistryStop, CanvasMoveCommandRegistryStop, ExportTemplateCommandRegistryStop, MoveComponentCommandRegistryStop, OpenAssetsCommandRegistryStop, OpenBlocksCommandRegistryStop, OpenLayersCommandRegistryStop, OpenStyleManagerCommandRegistryStop, OpenTraitManagerCommandRegistryStop, SelectComponentCommandRegistryStop, ShowOffsetCommandRegistryStop, SwitchVisibilityCommandRegistryStop {
}
...
export type CommandRunArgs<TId extends string> = TId extends keyof CommandRegistryRun ? Parameters<CommandRunPublicFn<TId>> : [
	options?: any
];
export type CommandStopArgs<TId extends string> = TId extends keyof CommandRegistryStop ? Parameters<CommandStopPublicFn<TId>> : [
	options?: any
];
export type CommandRunOptions<TId extends string> = TId extends keyof CommandRegistryRun ? CommandPublicOptions<CommandRunPublicFn<TId>> : any;
export type CommandStopOptions<TId extends string> = TId extends keyof CommandRegistryStop ? CommandPublicOptions<CommandStopPublicFn<TId>> : any;
export type CommandRunResult<TId extends string> = TId extends keyof CommandRegistryRun ? ReturnType<CommandRunPublicFn<TId>> : any;
export type CommandStopResult<TId extends string> = TId extends keyof CommandRegistryStop ? ReturnType<CommandStopPublicFn<TId>> : any;
export type CommandFunctionById<TId extends string> = CommandFunction<CommandRunOptions<TId>, CommandRunResult<TId>>;
export type CommandObjectById<TId extends string, T extends ObjectAny = {}> = CommandObject<CommandRunOptions<TId>, T, CommandStopOptions<TId>, CommandRunResult<TId>, CommandStopResult<TId>>;
export type CommandConstructorById<TId extends string> = CommandConstructor<CommandRunOptions<TId>, CommandStopOptions<TId>, CommandRunResult<TId>, CommandStopResult<TId>>;
export type CommandDefinitionById<TId extends string, T extends ObjectAny = {}> = CommandFunctionById<TId> | CommandObjectById<TId, T> | CommandConstructorById<TId>;
...
export type PluginCleanupHandler = (ctx: {
	cleanup: PluginCleanup;
	plugin: PluginItem;
}) => void;
export type PluginEvent = `${PluginsEvents}`;
declare enum PluginsEvents {
	/**
...
declare class ParserCss {
	private em?;
	private config;
	constructor(em?: EditorModel | undefined, config?: ParserConfig);
	/**
...
export interface ParserHtmlInternalOptions extends ParseNodeOptions {
	__parsedMode?: boolean;
	__syntheticElementCtor?: SyntheticElementCtor;
}
declare class ParserHtml {
	private em?;
	private config;
	...
	shouldConvertAttributeValue(attribute: string, value: string | boolean, node: HTMLElement | ParsedElementNode, convertAttributeValues: HTMLParserOptions["convertAttributeValues"]): boolean;
	/**
	...
	parseNodeAttr(node: ParsedNodeMeta, modelResult?: ComponentDefinitionDefined, opts?: HTMLParserOptions): ComponentDefinitionDefined;
	detectNode(node: ParsedNodeMeta, opts?: ParserHtmlInternalOptions): ComponentDefinitionDefined;
	parseNode(node: ParsedNodeMeta, opts?: ParserHtmlInternalOptions): ComponentDefinitionDefined;
	/**
	 * Get data from the node element
	 * @param  {HTMLElement} el DOM element to traverse
	 * @return {Array<Object>}
	 */
	parseNodes(el: ParsedNodeMeta, opts?: ParserHtmlInternalOptions): ComponentDefinitionDefined[];
	/**
	...
	__getSyntheticNode(node: ParsedNodeMeta, opts: ParserHtmlInternalOptions): any;
	__parseInput(input: string, options: HTMLParserOptions, cf: ParserConfig, parserCode: string): {
		root: ParsedNode;
		isParsedMode: boolean;
	};
	__getParserCodeId(options: HTMLParserOptions): string;
...
declare class ParserModule extends Module<ParserConfig & {
	...
	parserCss: ParserCss;
	parsersCode: Map<string, CustomParserCode>;
	 ...
	 */
	addParserCode(id: string, parse: CustomParserCodeFunction, options?: {
		skipSelect?: boolean;
	}): {
		id: string;
	 ...
	 */
	getParserCode(id: string): CustomParserCode | undefined;
	/**
	 * Remove an HTML code parser from the registry.
	 * @param {string} id Parser ID
	 * @returns {Object|undefined} Removed parser definition
	 */
	removeParserCode(id: string): CustomParserCode | undefined;
...
declare class CommandsModule extends Module<CommandsConfig & {
	 ...
	 * */
	add<const TId extends string, T extends ObjectAny = {}>(id: TId, command: CommandDefinitionById<TId, T>): this;
	/**
	 ...
	 * });
	 * */
	extend<const TId extends string>(id: TId, cmd?: CommandObjectById<TId, ObjectAny>): this;
	/**
	 ...
	 * @return {Object}
	 */
	getAll(): Record<string, CommandStored>;
	/**
	 * Execute the command
	 ...
	 * @private
	 */
	runCommand(command?: CommandAbstract, options?: CommandOptions): any;
	/**
	 * Stop the command
	 * @param  {Object} command
	 * @param {Object} options
	 ...
	 * @private
	 */
	stopCommand(command?: CommandAbstract, options?: CommandOptions): any;
	/**
	 ...
	 * @private
	 * */
	create(command: CommandObjectById<string, ObjectAny>): CommandAbstract<any, any, any, any>;
	__onRun(id: string, clb: () => void): void;
	__onStop(id: string, clb: () => void): void;
	destroy(): void;
}
declare class PluginModel extends Model<PluginItemProps> {
	defaults(): PluginItemProps;
}
declare class Plugins extends Collection<PluginModel> {
}
declare class PluginManager extends ItemManagerModule<ModuleConfig, Plugins> {
	events: typeof PluginsEvents;
	storageKey: string;
	constructor(em: EditorModel);
	get editor(): Editor;
	private getConfigPluginOptions;
	private generatePluginId;
	private resolvePluginId;
	private resolvePluginTarget;
...
export type EditorBuiltInEvents = EditorCoreEvent | DataSourceEvent | DeviceEvent | I18nEvent | ComponentEvent | BlockEvent | AssetEvent | KeymapEvent | LayerEvent | PageEvent | ParserEvent | PluginEvent | StyleManagerEvent | StorageEvent | CanvasEvent | SelectorEvent | RichTextEditorEvent | TraitEvent | ModalEvent | CommandEvent;
...
declare class StyleableModel<T extends StyleableModelProperties = any> extends Model<T, UpdateStyleOptions> {
	...
	protected __getStyleForExtend(): StyleProps;
	protected __getStyleForUpdate(opts?: UpdateStyleOptions): StyleProps;
	protected __normalizeStyle(style: ObjectAny, opts?: UpdateStyleOptions): ObjectAny;
	protected __onStyleUpdate(propOrig: StyleProps, opts?: UpdateStyleOptions): void;
	protected __getStyleResult(style: StyleProps, prop: keyof StyleProps | "" | undefined, opts?: GetStyleOpts): StyleProps | StyleProps[keyof StyleProps] | undefined;
	/**
	 * Get style object
	 * @return {Object}
	 */
	...
	protected __styleToString(style: StyleProps, opts?: ToCssOptions): string;
	protected __stylePropToString(prop: string, value: StyleProps[keyof StyleProps], opts?: ToCssOptions): string;
...
export declare class CssRule extends StyleableModel<CssRuleProperties> {
	...
	protected __attachNestedRule(rule: CssRule, key: string, opts?: UpdateStyleOptions): CssRule;
	protected __detachNestedRule(rule: CssRule, opts?: UpdateStyleOptions): void;
	protected __createNestedRule(key: string, value: unknown, opts?: UpdateStyleOptions): CssRule;
	protected __normalizeStyle(style: ObjectAny, opts?: UpdateStyleOptions): {
		[x: string]: any;
	};
	protected __getStyleForExtend(): StyleProps;
	protected __getStyleForUpdate(opts?: UpdateStyleOptions): StyleProps;
	protected __onStyleUpdate(prevStyle: StyleProps, opts?: UpdateStyleOptions): void;
	protected __getStyleResult(style: StyleProps, prop: keyof StyleProps | "" | undefined, opts?: GetStyleOpts): string | string[] | ObjectAny | DataResolverProps | undefined;
	protected __stylePropToString(prop: string, value: StyleProps[keyof StyleProps], opts?: ToCssOptions): string;
	clone(): typeof this;
...
declare abstract class ItemManagerModule<TConf extends ModuleConfig = ModuleConfig, TCollection extends Collection = Collection> extends Module<TConf> {
	...
	__onAllEvent(): void;
	_createId(len?: number, increase?: number): string;
...
export declare const usePlugin: <P extends Plugin<any> | string>(plugin: P, opts?: P extends Plugin<infer C> ? C : {}) => PluginWithMeta<any>;
export declare const grapesjs: {
	$: any;
	editors: Editor[];
	plugins: {
		add: <T extends PluginOptions>(id: string, plugin: Plugin<T>) => Plugin<T>;
		get: (pluginId: string) => Plugin<any> | undefined;
		getAll: () => Map<string, Plugin<any>>;
		clear: () => void;
	};
	usePlugin: <P extends Plugin<any> | string>(plugin: P, opts?: P extends Plugin<infer C> ? C : {}) => PluginWithMeta<any>;
	version: string;
	/**
